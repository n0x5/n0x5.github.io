...
sql_db = os.path.join(os.path.dirname( __file__ ), 'Discogs_Releases_Database_2022-12_COMPLETE_CD_ONLY_Europe.db')
...
for event, elem in tqdm(context):
    ...
    if 'CD' in str(format_name) and 'Europe' in country:
        lst.append(stuff)
    if len(lst) == 2000:
