...
results = [itest for itest in cur_new.execute('select project_name, downloads, meta, dev_status, summary from pypi_new where lower(meta) like "%{}%"' .format(section.lower()))]
